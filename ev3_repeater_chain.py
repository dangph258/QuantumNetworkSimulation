...
def create_qprocessor(name):
    ...
    deph_rate = 1000
    gate_duration = 1
    gate_noise_model = DephaseNoiseModel(deph_rate)
    mem_noise_model = DepolarNoiseModel(depo_rate)
...
def create_plot(num_iters=2000):
    ...
    fig, ax = plt.subplots()
    for distance in [1,5,10,15,20,25,30]:
